...
public class SparkConfig {
    ...
    public SparkSession createSparkSession(@Value("${cloudoptimized.sparkSessionName:DEFAULT_SESSION}") String sessionName) {
        ...
        config.set("spark.sql.parquet.mergeSchema", "false");
...
//        config.set("spark.hadoop.fs.s3a.aws.credentials.provider", "org.apache.hadoop.fs.s3a.TemporaryAWSCredentialsProvider");
